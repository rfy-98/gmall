...
public class AttrGroupController {
    ...
    @ApiOperation("根据三级分类id查询分组及分组规格参数")
    @GetMapping("withattrs/{categoryId}")
    public ResponseVo<List<GroupVo>> queryById(@PathVariable("categoryId")Long categoryId){
         List<GroupVo> groupVos = this.attrGroupService.queryById(categoryId);
